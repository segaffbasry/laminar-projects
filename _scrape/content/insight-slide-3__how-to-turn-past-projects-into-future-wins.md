# Laminar Projects | How To Turn Past Projects into Future Wins

URL: https://www.laminarprojects.com/insight-slide-3/how-to-turn-past-projects-into-future-wins
Description: Past projects have a wealth of knowledge and experience, so creating a lessons-learned register is crucial for optimising future projects and avoid repeating the same mistakes.
...
On a project level, . Implementing good practice happens through iterations and depend on accumulated experience gained by each individual. If the team changes, we are back to square one.
the main problem is that there is no defined process in place to capture these lessons
