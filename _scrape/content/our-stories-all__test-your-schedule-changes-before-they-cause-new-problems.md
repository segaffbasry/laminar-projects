# Insights | Test your schedule changes — before they cause new problems

URL: https://www.laminarprojects.com/our-stories-all/test-your-schedule-changes-before-they-cause-new-problems
Description: Learn how our Visual Comparison tool helps you to see the potential impact of planning changes — before you have to make them.
...
## [hero-blogs-size]
### Test your schedule changes — before they cause new problems

## [main-body]
When managing a project, one poor decision can set the schedule back weeks. For part two of our visual planning series, Hilal Demircapa and Nick Martinis discuss the model they use to make better planning decisions, faster.
...
“To make this possible, Lead Consultant and Senior Consultant from our visual planning team have created the Visual Comparison tool,” Hilal explains. “With this model in their pockets, commercial teams can quickly and easily compare different scenarios and get visibility over the effect of their decisions.”
- CTA: **Nick Martinis** -> https://www.laminarprojects.com/team/nick-martinis
- CTA: **Liezle Dollente** -> https://www.laminarprojects.com/team/liezle-dollente
As with the
Visual Lookahead tool
, Hilal and her team have developed a simulation to show you exactly how the Visual Comparison model runs and what it looks like in action.
Click to play:
This simulation shows how Visual Comparison translates theoretical uncertainties into a clear comparison between two eventualities: the and the
current plan
what-if scenario.
...
To get control over the project – and to keep it, when faced with daily challenges – they needed to be able to the impact of their decisions in space and time, in one view.
see
...
This approach has given her control, not just of the but also the ecisions are backed by hard, visual data. You can see the logic behind each possibility. Teams feel empowered, and everyone has a shared reference point – one clear picture of the present as well as possible futures.
when
how. D
> ‍
...
Picture the next decision you need to make – only this time, you can already see how it ends.
- CTA: **planning** -> https://www.laminarprojects.com/project-planning-and-controls
Interested in visual planning? Catch the full series:
•
Part 1: See a clash before it happens — and fix it before it costs you
Part 3: One missing detail. Weeks of rework. Here's how to catch it early.
